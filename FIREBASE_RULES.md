...
- ผู้เล่นที่ล็อกอินแล้ว และอยู่ใน `rooms/{roomId}/players` อ่าน `public` ได้
- เจ้าของห้อง (hostUid) เขียน `public` และจัดการ flow ของเกมได้
- ผู้เล่นที่อยู่ในห้องเดียวกันสามารถอ่าน/เขียน `private` ได้ทั้งหมด (เพื่อให้เล่นแบบเครื่องเดียวผลัดกันถือสะดวก)

- ผู้เล่นที่ล็อกอินแล้ว อ่าน `public` ได้
- เจ้าของห้อง (hostUid) เขียน `public` และจัดการ flow ของเกมได้
- ผู้เล่นที่อยู่ในห้องสามารถอ่าน/เขียน `private` ได้ทั้งหมด (เพื่อให้เล่นแบบเครื่องเดียวผลัดกันถือสะดวก)

- ปุ่มข้ามเวลา/รวมผลยังให้ host เป็นคนกดจากฝั่ง UI เท่านั้น
